...
export const defaultApps: App[] = [
  ...
  { id: '12', name: 'YouTube', url: 'https://youtube.com', iconUrl: 'https://icon.horse/icon/youtube.com/256', category: 'Entertainment', isCustom: false, isFavorite: false },
  ...
  { id: '14', name: 'Coinbase', url: 'https://www.coinbase.com', iconUrl: 'https://icon.horse/icon/coinbase.com/256', category: 'Cex', isCustom: false, isFavorite: false },
  { id: '15', name: 'Axie Infinity', url: 'https://axieinfinity.com', iconUrl: 'https://icon.horse/icon/axieinfinity.com/256', category: 'Web3 Games', isCustom: false, isFavorite: false },
  { id: '16', name: 'dogwifhat', url: 'https://dogwifcoin.org/', iconUrl: 'https://icon.horse/icon/dogwifcoin.org/256', category: 'Memes', isCustom: false, isFavorite: false },
];
